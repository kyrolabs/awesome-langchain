...
- [Agent Memory Guard](https://github.com/OWASP/www-project-agent-memory-guard) - OWASP-backed security middleware for LangChain agents. Detects and blocks memory poisoning attacks. `pip install agent-memory-guard`
