...
- [Lumin](https://github.com/amitbidlan/zistica-lumin): Local-first AI agent observability with a tenant-isolation firewall built in. LangChain auto-instrumentation via `LUMIN_TRACING=true`. Self-hosted single Docker container, DuckDB-backed. ![GitHub Repo stars](https://img.shields.io/github/stars/amitbidlan/zistica-lumin?style=social)
