...
- [langchain-veroq](https://github.com/Veroq-api/langchain-veroq): 40 LangChain tools for verified financial intelligence — market data, trading signals, sentiment analysis, and LLM output fact-checking with evidence chains. `pip install langchain-veroq` ![GitHub Repo stars](https://img.shields.io/github/stars/Veroq-api/langchain-veroq?style=social)
