...
- [Bulwark](https://github.com/anilatambharii/bulwark) - Defense framework for LangChain agents — `secure_tool()` and `secure_toolkit()` wrap your tools with prompt-injection detection, RBAC, audit, and human-confirmation gates.
