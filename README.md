...
- [AgentGuard](https://github.com/bmdhodl/agent47): Runtime guardrails for LangChain agents — budget enforcement, loop detection, and cost tracking with a drop-in callback handler ![GitHub Repo stars](https://img.shields.io/github/stars/bmdhodl/agent47?style=social)
