...
- [selectools](https://github.com/johnnichev/selectools): Python agent framework with visual builder, plain Python orchestration, HITL via generators, and 50+ built-in evaluators. Drag-and-drop workflows at selectools.dev. ![GitHub Repo stars](https://img.shields.io/github/stars/johnnichev/selectools?style=social)
