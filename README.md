...
- [Vaultfire LangChain](https://github.com/Ghostkey316/vaultfire-langchain): On-chain trust verification tools for LangChain agents — Street Cred scoring, ERC-8004 identity, and partnership bond verification across Base, Avalanche, Arbitrum, and Polygon mainnet (134 verified contracts). ![GitHub Repo stars](https://img.shields.io/github/stars/Ghostkey316/vaultfire-langchain?style=social)
