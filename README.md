...
- [EvalView](https://github.com/hidai25/eval-view): Regression testing for AI agents. Snapshot behavior, detect tool call and output regressions, with golden baseline diffing and LLM-as-judge scoring. ![GitHub Repo stars](https://img.shields.io/github/stars/hidai25/eval-view?style=social)
