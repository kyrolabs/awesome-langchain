...
- [ChunkTuner](https://github.com/shantanu-deshmukh/chunktuner): Benchmark and select document chunking strategies for RAG (Python lib, CLI `chunk-tune`, MCP `chunk-tune-mcp`); scores retrieval with metrics like recall/MRR/NDCG and optional RAGAS. ![GitHub Repo stars](https://img.shields.io/github/stars/shantanu-deshmukh/chunktuner?style=social)
