...
- [ForceField](https://github.com/Data-ScienceTech/forcefield) - AI security SDK for LangChain. Detect prompt injection, PII leaks, jailbreaks, and 13+ attack categories as a callback handler. Zero-config, offline, 100% detection rate with ML. `pip install langchain-forcefield` ![GitHub Repo stars](https://img.shields.io/github/stars/Data-ScienceTech/forcefield?style=social)
