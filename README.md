...
- [Agent Toolbelt](https://github.com/marras0914/agent-toolbelt): 20 focused API tools for AI agents with LangChain DynamicStructuredTool wrappers — schema generation, token counting, regex building, prompt optimization, web summarization, document comparison, and more. ![GitHub Repo stars](https://img.shields.io/github/stars/marras0914/agent-toolbelt?style=social)
