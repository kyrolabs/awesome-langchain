...
- [Entroly](https://github.com/juyterman1000/entroly): An intelligent context compression proxy and CLI that reduces LLM token costs by up to 95% while maintaining 100% benchmark accuracy via dependency scaffolding. ![GitHub Repo stars](https://img.shields.io/github/stars/juyterman1000/entroly?style=social)
