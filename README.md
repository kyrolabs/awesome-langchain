...
- [DeepAgents Open Lovable](https://github.com/emanueleielo/deepagents-open-lovable): Open-source AI-powered frontend development platform built on DeepAgents and LangGraph. Generate complete React applications through natural language conversations. ![GitHub Repo stars](https://img.shields.io/github/stars/emanueleielo/deepagents-open-lovable?style=social)
- [Ciana Parrot](https://github.com/emanueleielo/ciana-parrot): Self-hosted personal AI assistant built on LangChain with multi-channel support (Telegram, web), scheduled tasks, and an extensible skills system. ![GitHub Repo stars](https://img.shields.io/github/stars/emanueleielo/ciana-parrot?style=social)
- [Compact Middleware](https://github.com/emanueleielo/compact-middleware): Claude Code's context compaction engine packaged as a drop-in DeepAgents/LangGraph middleware for managing long agent conversations. ![GitHub Repo stars](https://img.shields.io/github/stars/emanueleielo/compact-middleware?style=social)
- [Advisor Middleware](https://github.com/emanueleielo/advisor-middleware): Anthropic's Advisor strategy as a drop-in DeepAgents/LangGraph middleware for structured multi-agent reasoning. ![GitHub Repo stars](https://img.shields.io/github/stars/emanueleielo/advisor-middleware?style=social)
