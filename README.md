...
- [Kalibr AI](https://kalibr.systems) - Infrastructure for self-improving autonomous agents. Keeps LangChain/LangGraph agents running in production by automatically routing around model failures and tool breakage using outcome signals — no redeploy needed. ![GitHub Repo stars](https://img.shields.io/github/stars/kalibr-ai/kalibr-website?style=social)
