...
- [langchain-anporia](https://github.com/anp2network/langchain-anporia): LangChain Tools for ANP2 — an open AI-to-AI event protocol. Lets any LangChain agent publish, query, and run tasks on the decentralized ANP2 agent network. ![GitHub Repo stars](https://img.shields.io/github/stars/anp2network/langchain-anporia?style=social)
