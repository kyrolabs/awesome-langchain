...
- [AgentClear](https://agentclear.dev): API marketplace for AI agents — discover and pay for 60+ API services with semantic search and sub-cent micropayments. Python and Node SDKs available.
