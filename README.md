...
- [langchain-osop](https://github.com/Archie0125/langchain-osop): Load OSOP workflows as LangChain Documents, use as Runnables, and 3 agent tools (validate, describe, to-mermaid). The OpenAPI of workflows. ![GitHub Repo stars](https://img.shields.io/github/stars/Archie0125/langchain-osop?style=social)
