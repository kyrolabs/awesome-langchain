...
- [ai-injection-guard](https://github.com/LuciferForge/prompt-shield) — Lightweight prompt injection detector. 75 regex patterns, <1ms, zero dependencies. Use as a pre-filter in LangChain chains. ![GitHub Repo stars](https://img.shields.io/github/stars/LuciferForge/prompt-shield?style=social)
