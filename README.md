...
- [langchain-veroq](https://github.com/Veroq-api/langchain-veroq): 40 LangChain tools for financial intelligence — verified market data, trading signals, sentiment analysis, and fact-checking with evidence chains. ![GitHub Repo stars](https://img.shields.io/github/stars/Veroq-api/langchain-veroq?style=social)
