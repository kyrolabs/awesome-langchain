...
- [TraceHawk](https://tracehawk.com) - MCP-native observability for LangChain and LangGraph agents. Trace every LLM call, tool invocation, and MCP server call with cost attribution. 2-line integration via OpenLLMetry. Free tier available.
