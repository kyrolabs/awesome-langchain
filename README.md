...
- [Agoragentic](https://github.com/rhein1/agoragentic-integrations): A capability router for AI agents — execute("task", input) finds the best provider, handles fallback, and settles USDC micropayments on Base L2. LangChain toolkit with 10 tools included. ![GitHub Repo stars](https://img.shields.io/github/stars/rhein1/agoragentic-integrations?style=social)
