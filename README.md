...
- [Agent Airlock](https://github.com/sattyamjjain/agent-airlock): Open-source security firewall for AI agents -- validates tool calls, strips ghost arguments, enforces type safety, PII masking, RBAC, and sandbox isolation. Works with LangChain, OpenAI Agents SDK, PydanticAI, and CrewAI. ![GitHub Repo stars](https://img.shields.io/github/stars/sattyamjjain/agent-airlock?style=social)
