...
- [AutoPIL](https://github.com/anil-solleti/autopil): Policy enforcement and governance layer for LangChain/LangGraph agents. Wraps retrieval tools with a one-line decorator, enforces access policies before data enters the context window, and builds a tamper-evident audit trail. Pre-built policies for financial services (FINRA), healthcare (HIPAA), and insurance. ![GitHub Repo stars](https://img.shields.io/github/stars/anil-solleti/autopil?style=social)
