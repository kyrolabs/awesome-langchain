...
- [AgentDBG](https://github.com/Sigmabrogz/agent-devtools): Chrome DevTools for AI Agents - real-time debugging with pause, resume, step-through, and breakpoints for LangChain workflows ![GitHub Repo stars](https://img.shields.io/github/stars/Sigmabrogz/agent-devtools?style=social)
