...
- [agent-pay](https://github.com/agentpay-protocol/agent-pay): Payment protocol for AI agents — let LangChain agents send and receive USDC/ETH payments autonomously on Base L2 ![GitHub Repo stars](https://img.shields.io/github/stars/agentpay-protocol/agent-pay?style=social)
