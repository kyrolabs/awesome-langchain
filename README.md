...
- [Arsenal](https://github.com/darshjme/arsenal): 100 zero-dependency Python libraries for LLM agent failure modes in production. Each library solves one specific failure class with 4375 tests. MIT license. ![GitHub Repo stars](https://img.shields.io/github/stars/darshjme/arsenal?style=social)
