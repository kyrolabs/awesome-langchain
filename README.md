...
- [langchain-signalfuse](https://github.com/hypeprinter007-stack/signalfuse-mcp): LangChain tools for live crypto trading signals — fused sentiment, macro regime, and market structure from SignalFuse API. ![GitHub Repo stars](https://img.shields.io/github/stars/hypeprinter007-stack/signalfuse-mcp?style=social)
