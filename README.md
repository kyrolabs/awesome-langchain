...
- [AgentAuth](https://github.com/jacobgadek/agent-auth) - Sync local Chrome sessions to LangChain agents for automatic authentication (bypasses login/2FA). ![GitHub Repo stars](https://img.shields.io/github/stars/jacobgadek/agent-auth?style=social)
