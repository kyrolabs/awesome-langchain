...
- [Blindfold](https://github.com/blindfold-dev/langchain-blindfold): LangChain document transformer that detects and removes PII (names, emails, phones, addresses, SSNs, etc.) across 18+ languages before data reaches LLMs. Supports tokenization, redaction, masking, and encryption with GDPR/HIPAA compliance policies. ![GitHub Repo stars](https://img.shields.io/github/stars/blindfold-dev/langchain-blindfold?style=social)
