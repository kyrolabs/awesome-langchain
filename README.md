...
- [Registry Broker](https://github.com/hashgraph-online/registry-broker): Universal index and routing layer for AI agents. Aggregates agent metadata from multiple registries (NANDA, MCP, Virtuals, OpenRouter, A2A) across web2 and web3, with protocol translation between agent ecosystems. ![GitHub Repo stars](https://img.shields.io/github/stars/hashgraph-online/registry-broker?style=social)
