...
- [AgentShield](https://github.com/kshkrao3/agentshield) - Runtime security middleware for LangChain agents. Drop-in adapter blocks prompt injection, enforces tool allowlists/denylists, and quarantines untrusted memory writes. Zero dependencies, Python + TypeScript. ![GitHub Repo stars](https://img.shields.io/github/stars/kshkrao3/agentshield?style=social)
