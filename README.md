...
- [ASK — Agent Skills Kernel](https://github.com/srmbsrg/ask-kernel) — Versioned, composable skill library for AI agents. Define capabilities once, invoke by name across any agent. MIT.
