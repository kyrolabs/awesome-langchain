...
- [AgentGuard](https://github.com/bmdhodl/agent47): Runtime observability and guardrails for AI agents — loop detection, budget enforcement, cost tracking, and deterministic replay. LangChain integration via BaseCallbackHandler. Zero dependencies. ![GitHub Repo stars](https://img.shields.io/github/stars/bmdhodl/agent47?style=social)
