...
- [Agent Brain](https://github.com/kaderosio/agent-brain): 7-layer cognitive memory system for AI agents with perception gate, dream cycle, and predictive capabilities. Self-hostable, no LLM required. ![GitHub Repo stars](https://img.shields.io/github/stars/kaderosio/agent-brain?style=social)
