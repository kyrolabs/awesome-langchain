...
- [Swrly](https://swrly.com): Visual AI agent orchestration platform. Alternative to hand-rolling agent graphs — drag-and-drop builder, 51+ connectors, hosted execution, full observability, BYOK. ![GitHub Repo stars](https://img.shields.io/github/stars/swrlyai/swrly)
