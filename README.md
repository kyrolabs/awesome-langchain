...
- [Clicks Protocol](https://github.com/clicks-protocol/clicks-protocol): Autonomous DeFi yield for AI agents on Base. SDK + MCP Server + CLI to auto-split USDC payments 80/20 between liquid funds and Aave/Morpho yield. ![GitHub Repo stars](https://img.shields.io/github/stars/clicks-protocol/clicks-protocol?style=social)
