...
- [zarq-langchain](https://pypi.org/project/zarq-langchain/) - Pre-trade crypto risk scoring for LangChain agents. Trust score, crash probability, and SAFE/WARNING/CRITICAL verdict for 205 tokens. Free API, no auth. `pip install zarq-langchain` ![GitHub Repo stars](https://img.shields.io/github/stars/zarq-ai/zarq-mcp-server?style=social) 
