...
- [air-langchain-trust](https://github.com/airblackbox/air-langchain-trust): Drop-in callback handler for EU AI Act compliance — adds HMAC audit chains, consent gating, PII tokenization, and injection detection to LangChain agents. ![GitHub Repo stars](https://img.shields.io/github/stars/airblackbox/air-langchain-trust?style=social)- [LangFair](https://github.com/cvs-health/langfair): LangFair is a Python library for conducting use-case-specific LLM bias and fairness assessments ![GitHub Repo stars](https://img.shields.io/github/stars/cvs-health/langfair?style=social)
