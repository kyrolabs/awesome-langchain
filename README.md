...
- [AgentShield](https://github.com/hidearmoon/agentshield) - Runtime security layer for AI agents with drop-in LangChain integration. Inspects every tool call through trust-aware data flow, 3-layer intent consistency detection, and Merkle audit trail. ![GitHub Repo stars](https://img.shields.io/github/stars/hidearmoon/agentshield?style=social)
