...
- [Memstore](https://memstore.dev): Persistent memory REST API for LangChain agents. Store and recall context semantically across runs using pgvector. ![GitHub Repo stars](https://img.shields.io/github/stars/CodeAndCalories/memstore?style=social)
