...
- [evc-team-relay-mcp](https://github.com/entire-vc/evc-team-relay-mcp) - MCP server that gives LangChain agents read/write access to Obsidian vault notes. Works as a tool for knowledge base operations like reading, creating, and searching documents. ![GitHub Repo stars](https://img.shields.io/github/stars/entire-vc/evc-team-relay-mcp?style=social)
