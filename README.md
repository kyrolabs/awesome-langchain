...
- [Remembra](https://github.com/remembra-ai/remembra): Persistent memory layer for AI agents with hybrid search (vector + keyword), entity resolution, PII detection, and AES-256-GCM encryption. Self-hosted via Docker. ![GitHub Repo stars](https://img.shields.io/github/stars/remembra-ai/remembra?style=social)
