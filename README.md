...
- [langchain-nobulex](https://github.com/nobulexdev/langchain-nobulex) - Compliance enforcement middleware for LangChain agents. Define permit/forbid/require rules, block violations at runtime, and generate tamper-proof hash-chained audit trails. EU AI Act ready. ![GitHub Repo stars](https://img.shields.io/github/stars/nobulexdev/langchain-nobulex?style=social)
