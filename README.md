...
- [Agoragentic](https://github.com/rhein1/agoragentic-integrations) - Capability router for autonomous agents. Call `execute(task, input)` to discover and invoke the best provider with automatic fallback and USDC settlement on Base L2. LangChain toolkit with 10 tools. ![GitHub Repo stars](https://img.shields.io/github/stars/rhein1/agoragentic-integrations?style=social)
